                ...
                <div class="card-body">
                  <div class="float-left">
                    <div class="card-header-action">
                        <a href="{{ route('tahunajaran.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data Tahun Ajaran</a>
                    </div>
                  </div>
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                        @foreach ($tahunajaran as $tahunajarann)
                       <tr>
                        <td>
                            {{ $loop->iteration }}
                        </td>
                        ...
                        <td  class="text-center">
                            <a href="/tahunajaran/edit2/{{ $tahunajarann->id }}" class="btn btn-warning btn-action mr-1" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                            <form action="/tahunajaran/delete2/{{ $tahunajarann->id }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
