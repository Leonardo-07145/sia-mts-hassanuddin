      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div><h5 style="text-align: center; margin-top: 50px">SISTEM INFORMASI AKADEMIK</h5></div>
            <div><h5 style="text-align: center; margin-bottom: 25px">MTS HASSANUDDIN</h5></div>
            ...
            @if (session()->has('loginError'))
              <div class="alert alert-danger alert-dismissible show fade">
                <div class="alert-body">
                  ...
                  <i class="far fa-lightbulb"></i> {{ session('loginError') }}
                </div>
              </div>
            @endif
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form action="/login" method="post" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    <div class="d-block">
                    	<label for="password" class="control-label">Password (yyyy-mm-dd)</label>
