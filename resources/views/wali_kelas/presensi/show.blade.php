                  ...
                  <div class="float-left">
                    <div class="card-header-action">
                        <a href="/presensi/create/
                            {{ $tgl_presensi->id }}
                    " class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data Presensi</a>
                    </div>
                  </div>
                  ...
                  <div class="table-responsive">
                    ...
                    <tbody>
                       ...
                       <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('presensi.edit', $presensii->id) }}" class="btn btn-warning btn-action mr-1" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                            <form action="{{ route('presensi.destroy', $presensii->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
